...
class LanguageDetector
{
     ...
     * @param CacheManager|null $cacheManager 缓存管理器
     */
    ...
    private function loadBuiltinProfiles(): void
    {
        ...
        $this->languageProfiles = [
            'zh-CN' => [
                'chars' => [
                    '的' => 0.0950, '一' => 0.0350, '是' => 0.0320, '不' => 0.0280,
                    '了' => 0.0260, '在' => 0.0240, '人' => 0.0210, '有' => 0.0190,
                    '我' => 0.0180, '他' => 0.0170, '这' => 0.0160, '个' => 0.0150,
                    '们' => 0.0140, '中' => 0.0130, '来' => 0.0120, '上' => 0.0110,
                    '大' => 0.0100, '为' => 0.0095, '和' => 0.0090, '国' => 0.0085
                ],
                'script' => 'Han'
            ],
            'en-US' => [
            ...
            'ja-JP' => [
                'chars' => [
                    'の' => 0.0950, 'い' => 0.0850, 'る' => 0.0750, 'た' => 0.0650,
                    'て' => 0.0600, 'を' => 0.0550, 'は' => 0.0500, 'に' => 0.0450,
                    'が' => 0.0400, 'と' => 0.0350, 'で' => 0.0300, 'あ' => 0.0280,
                    'し' => 0.0260, 'も' => 0.0240, 'す' => 0.0220, 'か' => 0.0200
                ],
                'script' => 'Hiragana'
            ],
            'ko-KR' => [
                'chars' => [
                    '이' => 0.0900, '는' => 0.0850, '하' => 0.0750, '을' => 0.0700,
                    '가' => 0.0650, '에' => 0.0600, '서' => 0.0550, '로' => 0.0500,
                    '다' => 0.0450, '의' => 0.0400, '와' => 0.0350, '한' => 0.0300,
                    '지' => 0.0280, '을' => 0.0260, '고' => 0.0240, '자' => 0.0220
                ],
                'script' => 'Hangul'
            ],
            'ru-RU' => [
    ...
    private function detectByScript(string $text): array
    {
        $scripts = [
            ...
            'Hiragana' => '/[\x{3040}-\x{309f}]/u',  // 日文平假名
            'Katakana' => '/[\x{30a0}-\x{30ff}]/u',  // 日文片假名
            'Hangul' => '/[\x{ac00}-\x{d7af}]/u',  // 韩文
            'Cyrillic' => '/[\x{0400}-\x{04ff}]/u',  // 西里尔字母
            'Latin' => '/[a-zA-Z]/u'  // 拉丁字母
        ];
