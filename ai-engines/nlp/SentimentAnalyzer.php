...
class SentimentAnalyzer
{
    ...
    private function getDefaultConfig(): array
    {
        return [
            ...
            'use_cache' => true,
            'cache_size' => 1000,
            'negation_window' => 3, // 否定词影响范�?
            'min_confidence' => 0.6,
            'neutral_threshold' => 0.3, // 中性情感阈�?
     ...
     * @param array|null $tokens 分词结果，如果为null则自动分�?
