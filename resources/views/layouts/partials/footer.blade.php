    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                ...
                <p class="text-muted">AlingAi Pro是一个强大的人工智能平台，提供先进的AI工具和API服务，帮助开发者和企业轻松实现AI能力。</p>
            ...
            <div class="col-md-2 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="{{ route("api-docs") }}" class="text-muted text-decoration-none">API 文档</a></li>
