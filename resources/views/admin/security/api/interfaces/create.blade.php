    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form method="POST" action="{{ route('admin.security.api.interfaces.store') }}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="输入接口名称" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('path') is-invalid @enderror" id="path" name="path" value="{{ old('path') }}" placeholder="例如：users/{id}" required>
                                    </div>
                                    @error('path')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="输入接口描述">{{ old('description') }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('module') is-invalid @enderror" id="module" name="module" value="{{ old('module') }}" placeholder="输入所属模块，例如：用户管理">
                                    @error('module')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('version') is-invalid @enderror" id="version" name="version" value="{{ old('version', 'v1') }}" placeholder="输入API版本，例如：v1">
                                    @error('version')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="is_monitored" name="is_monitored" value="1" {{ old('is_monitored') ? 'checked' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="need_auth" name="need_auth" value="1" {{ old('need_auth', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control @error('rate_limit') is-invalid @enderror" id="rate_limit" name="rate_limit" value="{{ old('rate_limit', 60) }}" min="0">
                                                    @error('rate_limit')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control @error('timeout') is-invalid @enderror" id="timeout" name="timeout" value="{{ old('timeout', 5000) }}" min="0">
                                                    @error('timeout')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('request_params') is-invalid @enderror" id="request_params" name="request_params" rows="5" placeholder='[{"name": "username", "type": "string", "required": true, "description": "用户名"}, {"name": "password", "type": "string", "required": true, "description": "密码"}]'>{{ old('request_params') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('response_structure') is-invalid @enderror" id="response_structure" name="response_structure" rows="5" placeholder='{"code": 200, "message": "success", "data": {"id": 1, "username": "example"}}'>{{ old('response_structure') }}</textarea>
