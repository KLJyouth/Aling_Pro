...
/**
 * 增强数据表迁移脚本
 * 执行 enhancement_tables.sql 创建新的增强功能数据表
 */
...
try {
    ...
    // 读取增强数据表SQL文件
    $sqlFile = __DIR__ . '/install/sql/enhancement_tables.sql';
    if (!file_exists($sqlFile)) {
        throw new Exception("增强数据表SQL文件不存在: {$sqlFile}");
    }
