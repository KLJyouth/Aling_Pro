-- filepath: e:\Code\AlingAi\AlingAi_pro\database\migrations\009_create_conversation_history_table.sql
-- 对话历史表 - 支持AI代理和用户对话记录
...
-- 为对话历史添加索引优化
CREATE INDEX `idx_conversation_time_range` ON `conversation_history` (`conversation_id`, `created_at`);
CREATE INDEX `idx_user_agent_messages` ON `conversation_history` (`user_id`, `agent_id`, `created_at`);
