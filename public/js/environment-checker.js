...
class EnvironmentChecker {
    ...
    async checkAPIEndpoints() {
        ...
        try {
            const endpoints = [
                { url: API_ENDPOINTS.STATUS, desc: '状态检查' },
                { url: API_ENDPOINTS.PING, desc: '连通性测试' }
            ];
    ...
    async checkDatabaseConnection() {
        ...
        try {
            const response = await fetch(API_ENDPOINTS.HEALTH_DATABASE, {
                method: 'GET',
                cache: 'no-cache'
            });
    ...
    async sendErrorReport() {
        ...
        try {
            await fetch(API_ENDPOINTS.ERROR_REPORT, {
                method: 'POST',
                headers: {
