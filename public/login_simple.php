...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glassmorphism rounded-3xl p-8 w-full max-w-lg shadow-2xl z-10 relative">
        ...
        <!-- 常规登录表单 -->
        <form method="POST" action="/login_simple.php" class="space-y-6">
            <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="/login/google" class="glassmorphism flex items-center justify-center py-3 px-4 rounded-lg text-white">
                    <i class="fab fa-google text-red-400 mr-2"></i> Google登录
                </a>
                <a href="/login/github" class="glassmorphism flex items-center justify-center py-3 px-4 rounded-lg text-white">
