...
class AdminSystemTestSuite
{
    ...
    public function runAllTests(): array
    {
        ...
        $testSuites = [
            ...
            '数据库完整性测试' => [$this, 'testDatabaseIntegrity'],
    ...
    private function testApiGateway(): array
    {
        ...
        // 测试网关状态
        $response = $this->makeRequest('GET', '/gateway.php?action=status');
    ...
    private function testThirdPartyApi(): array
    {
        ...
        // 测试服务状态
        $response = $this->makeRequest('GET', '/third-party/status', [], true);
    ...
    private function testMonitoringApi(): array
    {
        ...
        // 测试系统状态
        $response = $this->makeRequest('GET', '/monitoring/system', [], true);
    ...
    private function testDatabaseIntegrity(): array
    {
        ...
        // 测试表结构
        $tables = ['admin_users', 'admin_tokens', 'admin_permissions'];
