...
return [
    ...
    */
    'cache' => [
        'driver' => env('CACHE_DRIVER', 'file'], // 可�? file, redis, array
    ...
    */
    'database' => [
        ...
        'query_cache_ttl' => 300, // 查询缓存生存时间（秒�?        'slow_query_threshold' => 1.0, // 慢查询阈值（秒）
        'log_slow_queries' => true, // 是否记录慢查�?    ], 
    ...
    */
    'api' => [
        'throttle' => [
            ...
            'max_attempts' => 60, // 最大请求次�?            'decay_minutes' => 1, // 限流时间窗口（分钟）
        ], 
