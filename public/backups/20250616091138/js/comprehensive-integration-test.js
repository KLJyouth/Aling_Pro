...
class ComprehensiveIntegrationTest {
    ...
    async runComprehensiveTest() {
        console.log('🚀 开始 AlingAi 集成系统完整验证');
        console.log('═══════════════════════════════════════');
    ...
    async runIntegrationFlowTesting() {
        ...
        for (const flow of this.integrationFlows) {
            ...
            for (let i = 0; i < flow.steps.length; i++) {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        console.log(`   ❌ 步骤 ${i + 1}: ${step} - ${result.error}`);
                    ...
                    console.log(`   ❌ 步骤 ${i + 1}: ${step} - 异常: ${error.message}`);
                }
            ...
            console.log(`   📊 流程${flowResult.success ? '成功' : '失败'}, 总耗时: ${flowResult.executionTime}ms`);
        }
    }
