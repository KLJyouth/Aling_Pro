...
class ZeroTrustAuth {
    ...
    updateRiskScore() {
        ...
        console.log('🔍 风险评分更新:', {
            ...
            deviceChanges: this.securityMetrics.deviceChanges,
            failedAttempts: this.securityMetrics.failedAttempts
        });
    }
    ...
    async requestMFA(loginData) {
        ...
        console.log('🔐 MFA请求 - 风险级别:', isHighRisk ? '高' : '低', '风险分数:', riskScore);
