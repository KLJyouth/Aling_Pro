...
class IntelligentAlertSystem {
    ...
    async loadHistoricalData() {
        ...
        console.log(`📊 已加载 ${this.learningData.length} 条历史数据用于机器学习`);
    }
    ...
    toggleAlertRule(ruleId) {
        ...
        if (rule) {
            ...
            console.log(`预警规则 ${ruleId} ${rule.enabled ? '已启用' : '已禁用'}`);
        }
    }
