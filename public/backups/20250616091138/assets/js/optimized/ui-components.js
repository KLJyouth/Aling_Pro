/**
 * ui-components.js - 龙凌科技优化合并文件
 * 生成时间: 2025-05-31T14:42:35.310Z
 * 包含文件: login-modal.js, chat-interface.js, notification-system.js, mobile-menu.js
 */
...
class NotificationSystem {
    ...
    createNotificationContainer() {
        ...
        if (document.body) {
            ...
            console.warn('⚠️ document.body不可用，延迟创建通知容器');
            // 等待DOM加载完成后再创建
