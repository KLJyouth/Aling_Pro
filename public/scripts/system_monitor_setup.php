...
class SystemMonitor
{
    ...
    {
        $this->thresholds = [
            'cpu_usage' => 80,          // CPU 使用率警告阈�?
            'memory_usage' => 85,       // 内存使用率警告阈�?
            'disk_usage' => 90,         // 磁盘使用率警告阈�?
            'response_time' => 2000,    // 响应时间警告阈�?(毫秒)
            'error_rate' => 5,          // 错误率警告阈�?(%)
            'connection_count' => 400,  // 数据库连接数警告阈�?
            'cache_hit_rate' => 85      // 缓存命中率最低阈�?(%)
        ];
    }
    ...
    private function setupAlertSystem()
    {
        ...
        $alertConfig = [
            ...
            'escalation' => [
                'warning_to_critical' => 1800,  // 30分钟后升�?
                'max_notifications' => 5,       // 最大通知次数
                'cooldown_period' => 3600      // 冷却�?小时
            ]
        ];
