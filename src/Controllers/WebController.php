...
class WebController extends BaseController {
     ...
     * 系统管理页面
     */
    public function systemManagement(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface 
    {
        // 检查管理员权限
        // 这里可以添加权限检查逻辑
        
        $templatePath = __DIR__ . '/../../resources/views/admin/system-management.html';
        
        if (!file_exists($templatePath)) {
            $response->getBody()->write('<h1>系统管理页面未找到</h1>');
