...
class Routes {
    ...
    public static function getApiRoutes() {
        return [
            ...
            // 聊天API (使用增强聊天控制器)
            'POST /api/v1/chat/send' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'sendMessage'],
            'GET /api/v1/chat/conversations' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'getConversations'],
            'POST /api/v1/chat/conversations' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'createConversation'],
            'GET /api/v1/chat/conversations/{id}/messages' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'getMessages'],
            'DELETE /api/v1/chat/conversations/{id}' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'deleteConversation'],
            'GET /api/v1/chat/stats' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'getUserStats'],
            'GET /api/v1/chat/health' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'healthCheck'],
            
            // 兼容旧版聊天API
            'POST /api/chat/send' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'sendMessage'],
            'GET /api/chat/conversations' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'getConversations'],
            'GET /api/chat/conversation/{id}' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'getMessages'],
            'DELETE /api/chat/conversation/{id}' => ['controller' => 'Api\\EnhancedChatApiController', 'method' => 'deleteConversation'],
