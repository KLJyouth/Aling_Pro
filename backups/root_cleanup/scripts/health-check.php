...
class SystemHealthChecker
{
    ...
    {
        $this->printSectionHeader("PHP环境检查");
        ...
        foreach ($requiredExtensions as $extension) {
            $this->test(
                ...
                extension_loaded($extension) ? "已安装" : "未安装"
            );
        }
    ...
    {
        $this->printSectionHeader("文件权限检查");
    ...
    {
        $this->printSectionHeader("数据库连接检查");
    ...
    {
        $this->printSectionHeader("Redis连接检查");
    ...
    {
        $this->printSectionHeader("核心服务检查");
    ...
    {
        $this->printSectionHeader("企业服务检查");
        
        $enterpriseFiles = [
            'apps/enterprise/Services/EnterpriseServiceManager.php' => '企业服务管理器',
            'apps/enterprise/Services/WorkspaceManager.php' => '工作空间管理器',
            'apps/enterprise/Services/ProjectManager.php' => '项目管理器',
            'apps/enterprise/Services/TeamManager.php' => '团队管理器'
        ];
    ...
    {
        $this->printSectionHeader("区块链服务检查");
        
        $blockchainFiles = [
            'apps/blockchain/Services/BlockchainServiceManager.php' => '区块链服务管理器',
            'apps/blockchain/Services/WalletManager.php' => '钱包管理器',
            'apps/blockchain/Services/SmartContractManager.php' => '智能合约管理器'
        ];
    ...
    {
        $this->printSectionHeader("安全服务检查");
        
        $securityFiles = [
            'apps/security/Services/ZeroTrustManager.php' => '零信任管理器',
            'apps/security/Services/AuthenticationManager.php' => '认证管理器',
    ...
    {
        $this->printSectionHeader("性能指标检查");
    ...
    {
        $this->printSectionHeader("API端点检查");
    ...
    {
        $this->printSectionHeader("前端资源检查");
    ...
    private function generateHealthReport(): void
    {
        ...
        echo "  • 成功率: " . sprintf("%.2f%%", $successRate) . "\n\n";
