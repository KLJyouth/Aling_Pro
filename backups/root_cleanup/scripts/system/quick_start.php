...
if ($returnCode === 0) {
    ...
    echo "  3D威胁可视化: http://localhost:8000/security/visualization\n";
    ...
    echo "💡 快速提示：\n";
    echo "  • 查看服务状态: php deploy/check_status.php\n";
    echo "  • 停止所有服务: php deploy/stop_services.php\n";
