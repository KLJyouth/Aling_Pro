...
HTACCESS;
    ...
    private function generateReport(): void
    {
        ...
        if (!empty($this->completedActions)) {
            ...
            foreach ($this->completedActions as $action) {
                switch ($action['action']) {
                    ...
                    case 'selective_copy':
                        $report .= "- 📋 **选择性复制**: `{$action['source']}/` → `{$action['target']}/`\n";
        ...
        $report .= "2. **静态资源**: 放置在 `public/assets/` 目录\n";
        ...
        echo "📋 优化报告已生成: " . basename($reportFile) . "\n";
        echo "🎉 Public目录优化完成！\n\n";
