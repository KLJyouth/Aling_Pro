    ...
    $app->group('/api', function (RouteCollectorProxy $group) {';
        ...
        $group->group('/v1', function (RouteCollectorProxy $group) {';
            ...
            $group->group('/history', function (RouteCollectorProxy $group) {';
                $group->get('', \AlingAi\Controllers\Api\HistoryApiController::class . ':getHistory');';
                $group->get('/{id}', \AlingAi\Controllers\Api\HistoryApiController::class . ':getDetailedHistory');';
                $group->delete('/{id}', \AlingAi\Controllers\Api\HistoryApiController::class . ':deleteHistory');';
            });
